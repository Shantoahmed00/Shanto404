...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mRongbaaz Tm \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Shanto Ahmed
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	os.system('clear')
	print logo
	print "\033[1;91m[1]\033[1;92mLogin With Facebook"
        time.sleep(0.05)
        print "\033[1;92m[2]\033[1;93mLogin With Token"
        time.sleep(0.05)
        print "\033[1;93m[3]\033[1;94mDownload Token App"
        time.sleep(0.05)
        print "\033[1;94m[4]\033[1;95mRongbaaz Tm"
        time.sleep(0.05)
	print "\033[1;95m[5]\033[1;96mC.E.O Faysal Billal Mir"
        time.sleep(0.05)
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;98m•-----------------\033[1;98mC.E.O Faysal Billal Mir\033[1;98m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open Shanto/Update/Rongbaaz tools ')
...
def menu():
	...
	time.sleep(0.05)
	print "\033[1;90m•-----------------\033[1;94mShanto Ahmed\033[1;90m-----------------•"
	print "\033[1;92m[1]\033[1;34mStart Fast Cloning"
	time.sleep(0.05)
	print "\033[1;93m[2]\033[1;34mID Not Found Problem Solve"
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;34mRest/Update RONGBAAZ TOOL"
	time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;92m•-----------------\033[1;35m{C.e.o Faysal billal mir }\033[1;93m-----------------•"
		print logo
		...
		try:
			...
			super()
		print"\033[1;98m[+]\033[1;90mC.E.O FAYSAL BILLAL MIR"
...
#Dev: Shanto Ahmed 
 ...
 \033[1;90m  C.E.O FAYSAL BILLAL MIR (VAI🥰)
\033[1;90m     Coding by Shanto Ahmed 
\033[1;90m     Powerd by Rongbaaz bd cyber security Tm 
\033[1;90m       Thanks use for our tools 🙂   
\033[1;90m          update coming soon   
\033[1;90m              Good bye                    
      
"""
	print "\033[1;95m«-----------------\033[1;35m✅C.E.O FAYSAL BILLAL MIR✅\033[1;95m-----------------»"
	raw_input("\n\033[1;96m[+]\033[1;95mBack")
	menu()

if __namemSHANTO__main__':
	login()
gin()
